...
from EIdrive.core.common.EIDriveEnv import EIDriveEnv
...
def run_scenario(opt, config_yaml):
    ...
    try:
        if train:
            ...
            model =SAC("MlpPolicy", env, verbose=1, learning_starts=5000, learning_rate=0.0003, ent_coef="0.1", gradient_steps=1, buffer_size=250000, device='auto', tensorboard_log="./tensorboard_logs/")
