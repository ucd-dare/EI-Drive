...
"""
This script tests the vision model
"""
...
class vision_model_test(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        """
        print("Running Vision Model Test")
        ...
        super(vision_model_test, self).__init__("vision_model_test",
                                          ego_vehicles,
                                          config,
                                          world,
                                          debug_mode,
