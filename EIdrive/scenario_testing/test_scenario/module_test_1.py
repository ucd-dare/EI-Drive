...
"""
This script runs module_test_1
"""
...
class module_test_1(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self.num_vehicle = 1
        self.vehicle_01_velocity = 5  # CAV
        self._trigger_distance = 100

        super(module_test_1, self).__init__("module_test_1",
                                          ego_vehicles,
                                          config,
                                          world,
                                          debug_mode,
