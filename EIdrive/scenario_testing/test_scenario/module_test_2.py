...
"""
This script runs module_test_2
"""
...
class module_test_2(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self.num_vehicle = 1
        self.vehicle_01_velocity = 5.5  # CAV
        self._trigger_distance = 50

        super(module_test_2, self).__init__("module_test_2",
                                            ego_vehicles,
                                            config,
                                            world,
                                            debug_mode,
