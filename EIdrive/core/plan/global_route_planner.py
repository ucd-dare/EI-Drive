...
class GlobalRoutePlanner(object):
    ...
    def _find_loose_ends(self):
        ...
        for segment in self._topology:
            ...
            if road_id in self._road_id_to_edge and \
                    section_id in self._road_id_to_edge[
                        road_id] and \
                ...
                while next_wp is not None and next_wp and \
                        next_wp[0].road_id == road_id and next_wp[
                            0].section_id == section_id and \
    ...
    def _localize(self, location):
        ...
        try:
            edge = \
                self._road_id_to_edge[waypoint.
                                      road_id][waypoint.
                                               section_id][waypoint.lane_id]
        except KeyError:
            print(
                "Failed to localize! : ",
        ...
        for segment in self._topology:
            ...
            for waypoint in segment['path']:
                if not segment['entry'].is_junction:
                    next_waypoint, next_road_option, next_segment \
                        = None, None, None
                        ...
                        if next_waypoint is not None \
                            ...
                            if next_segment is not None:
                                self._graph.add_edge(
                                    ...
                                    path=[], length=100, type=next_road_option,
    ...
    def _successive_last_intersection_edge(self, index, route):
        """
        This method returns the last successive intersection edge from a
        starting index on the route. This helps moving past tiny
        intersection edges to calculate proper turn decisions.
        """
            ...
            if self._previous_decision != RoadOption.VOID and \
                ...
                if calculate_turn:
                    ...
                    if tail_edge is not None:
                        next_edge = tail_edge
                    cv, nv = current_edge['exit_vector'], \
                        next_edge['exit_vector']
                ...
                for waypoint in path[closest_index:]:
                    ...
                    if len(
                        ...
                        break
                            ...
                            route) - i <= 2 and current_waypoint.road_id == \
