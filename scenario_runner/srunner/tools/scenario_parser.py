...
class ScenarioConfigurationParser(object):
    ...
    def parse_scenario_configuration(scenario_name, config_file_name):
        ...
        list_of_config_files = glob.glob("{}/scenario_runner/srunner/examples/*.xml".format(os.getenv('SCENARIO_RUNNER_ROOT', "./")))
    ...
    def get_list_of_scenarios(config_file_name):
        ...
        list_of_config_files = glob.glob("{}/scenario_runner/srunner/examples/*.xml".format(os.getenv('SCENARIO_RUNNER_ROOT', "./")))
        list_of_config_files += glob.glob("{}/scenario_runner/srunner/examples/*.xosc".format(os.getenv('SCENARIO_RUNNER_ROOT', "./")))
